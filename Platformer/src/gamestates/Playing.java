	...
	public Playing(Game game) {
	 ...
	 private void initClasses() {
		...
		private void drawClouds(Graphics pen) {
			...
			for(int i = 0 ; i < 3  ; i++)
			pen.drawImage(bigCloud, 0 + i * BIG_CLOUD_WIDTH - (int)(xLvlOffset  * 0.3) , (int)(204 * Game.SCALE) , BIG_CLOUD_WIDTH , BIG_CLOUD_HEIGHT , null);
			
			for(int i = 0 ; i < smallCloudsPos.length  ; i++)
			pen.drawImage(smallCloud, SMALL_CLOUD_WIDTH * 4 * i - (int)(xLvlOffset  * 0.7) , smallCloudsPos[i] , SMALL_CLOUD_WIDTH, SMALL_CLOUD_HEIGHT, null);
		}
